    ...
    return (
        <>
                ...
                <div className="inline-flex flex-col mt-2.5 md:mt-12">
                    <h1 className="text-center text-3xl font-extrabold hidden md:block">CONTACT</h1>
                    <div className="flex flex-row mx-auto mt-0 md:mt-3">
                        <Link href="/"><a className="text-gray-400 mr-2" >Home</a></Link> / <Link href="/contact"><a className="text-green-400 ml-2" >Contact</a></Link>
                    </div>
                </div>
            </section>
<section className="py-20 bg-coolGray-900" style={{backgroundImage: 'url("flex-ui-assets/elements/pattern-dark2.svg")', backgroundPosition: 'center'}}>
  <div className="container px-4 mx-auto">
    <div className="flex flex-wrap mb-24 lg:mb-18 justify-between items-center">
      <div className="w-full lg:w-1/2 mb-10 lg:mb-0">
        <span className="inline-block py-px px-2 mb-4 text-xs leading-5 text-green-900 bg-green-100 font-medium uppercase rounded-9xl">Contact</span>
        <h3 className="mb-4 text-4xl md:text-5xl text-white font-bold tracking-tighter leading-tight">Let’s stay connected</h3>
        <p className="text-lg md:text-xl text-coolGray-400 font-medium">Its never been easier to get in touch with Fabwelt. Call us, use our live chat widget or email and well get back to you as soon as possible!</p>
      </div>
      <div className="w-full lg:w-auto">
        <div className="flex flex-wrap justify-center items-center md:justify-start -mb-2"><a className="inline-block py-4 px-6 mb-2 md:mb-0 w-full md:w-auto md:mr-5 text-lg leading-6 text-coolGray-50 font-medium text-center bg-indigo-500 hover:bg-indigo-600 focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50 border border-transparent rounded-md shadow-sm" href="#">Support</a><a className="inline-block py-4 px-6 w-full md:w-auto text-lg leading-6 font-medium text-center text-coolGray-500 bg-white border border-coolGray-200 hover:border-coolGray-300 focus:ring-2 focus:ring-coolGray-200 focus:ring-opacity-50 rounded-md shadow-sm" href="#">About Us</a></div>
      </div>
    </div>
    <div className="flex flex-wrap -mx-4">
        ...
        <div className="flex flex-wrap -mx-4">
          <div className="w-full md:w-1/2 px-4 mb-10">
            <div className="max-w-xs mx-auto">
              <div className="inline-flex mb-6 items-center justify-center w-12 h-12 bg-green-500 rounded-full">
                <svg className="h-6 text-coolGray-900" width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <h3 className="mb-4 text-2xl md:text-3xl font-bold leading-9 text-white">Email</h3>
              <a className="text-lg md:text-xl text-coolGray-400 hover:text-coolGray-600 font-medium" href="mailto:#">contact@flex.co</a>
            </div>
          </div>
          <div className="w-full md:w-1/2 px-4 mb-10">
            <div className="max-w-xs mx-auto">
              ...
              <h3 className="mb-4 text-2xl md:text-3xl font-bold leading-9 text-white">Phone</h3>
              <p className="text-lg md:text-xl text-coolGray-400 font-medium">+ 7-843-672-431</p>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 px-4">
            <div className="max-w-xs mx-auto">
              ...
              <h3 className="mb-9 text-2xl md:text-3xl font-bold leading-9 text-white">Socials</h3>
              <a className="inline-block mr-8 text-green-500 hover:text-green-600" href="#">
              ...
              <a className="inline-block text-green-500 hover:text-green-600" href="#">
      ...
      <div className="w-full lg:w-1/2 px-4">
        <div className="px-4 py-8 md:p-10 bg-[#343444] rounded-md">
          <form>
            <div className="mb-6">
              <label className="block mb-2 text-gray-100 font-medium leading-6">Email</label>
              <input className="block w-full py-2 px-3 appearance-none border border-coolGray-200 rounded-lg shadow-md text-coolGray-500 leading-6 focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-opacity-50" type="email" placeholder="dev@shuffle.dev" />
            </div>
            <div className="mb-6">
              <label className="block mb-2 text-gray-100 font-medium leading-6">Message</label>
              <textarea className="block h-32 md:h-52 w-full py-2 px-3 appearance-none border border-coolGray-200 rounded-lg shadow-md text-coolGray-600 leading-6 focus:outline-none focus:shadow-outline focus:ring-2 focus:ring-violet-500 focus:ring-opacity-50 placeholder-coolGray-400 resize-none" placeholder="Your message..." defaultValue={""} />
            </div>
            <button className="block w-full py-4 px-6 text-lg leading-6 text-coolGray-100 font-medium text-center bg-purple-500 border hover:bg-indigo-600 focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50 rounded-md shadow-sm">Send</button>
          </form>
        </div>
      </div>
    </div>
